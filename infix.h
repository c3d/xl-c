...
inline infix_p      infix_new(srcpos_t position,
                              name_p opcode, tree_p left, tree_p right);
...
inline infix_p      infix_make(tree_handler_fn h, srcpos_t pos,
                               name_p opcode, tree_p left, tree_p right);
...
inline infix_p infix_make(tree_handler_fn handler, srcpos_t pos,
                          name_p opcode, tree_p left, tree_p right)
// ----------------------------------------------------------------------------
